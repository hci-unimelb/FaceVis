...
line()
print("bind req")
req.bind("tcp://"+address+":"+portin)
req.bind("tcp://"+address+":"+portout)
time.sleep(1)

line()
print("connect rep")
rep.connect("tcp://"+address+":"+portin)
time.sleep(0.2)
rep.connect("tcp://"+address+":"+portout)
time.sleep(1)

line()
print("disconnect rep")
rep.disconnect("tcp://"+address+":"+portin)
time.sleep(1)
rep.disconnect("tcp://"+address+":"+portout)
time.sleep(1)
